...
export default function BookingPage() {
  return (
    <main>
      <section className="diplomatic-mesh px-4 py-10 text-white sm:px-6 sm:py-16 lg:px-8">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mx-auto mt-4 max-w-xl text-sm leading-relaxed text-white/70 sm:text-base">
            ...
            hours, and submit your details. Your appointment is added to the
            Embassy Google Calendar and confirmed by email (Resend).
          </p>
        </div>
      </section>

      <section className="mx-auto max-w-5xl px-3 py-8 sm:px-6 sm:py-12 lg:px-8">
        <BookingWizard />
      </section>
    </main>
  );
